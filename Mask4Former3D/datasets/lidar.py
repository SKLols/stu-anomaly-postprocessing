...
class LidarDataset(Dataset):
    def __init__(
        ...
        data = [[]]
        ##print("data_type:", type(self.data))
        ##print("data_content:", self.data[:3])
        last_scene = self.data[0]["scene"]
        # For example, get the last training scene ID:
        #last_scene_id = self.data["split"]["train"][-1]
    ...
    def _load_yaml(filepath):
        print("Loading YAML from:", filepath)
